...
- Language: Python
- Runtime: 64 ms
- Completed time: 2019-03-24 20:13:45
...
class Solution(object):
    def hasCycle(self, head):
        ...
        if head == None:
            return False
        cursor1, cursor2 = head, head.next
        while cursor1 != None and cursor2 != None and cursor2.next != None:
            if cursor1 == cursor2:
                return True
...
Among **1850372** total submissions, **780540** are accepted, with an acceptance rate of **42.2%**. <br>
